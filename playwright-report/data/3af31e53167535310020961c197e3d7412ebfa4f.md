...
- Name: tests/e2e/auth.spec.ts >> @P0 @Auth Story-1.1: Authentication Journey >> [P0] should display sign-in page for unauthenticated users
...
```ts
  ...
  2   | 
  3   | /**
  4   |  * VLM Authentication E2E Tests
  5   |  * Story 1.1: Google OAuth Login (critical path via mock JWT)
  6   |  * Story 1.2: Route Guard — unauthorized redirect
  7   |  *
