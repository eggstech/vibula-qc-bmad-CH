...
- Name: tests/e2e/auth.spec.ts >> @P1 @RBAC Story-1.2: Route Guard Enforcement >> [P1] should allow Admin role user to access Master Data page
- Location: tests/e2e/auth.spec.ts:135:7
