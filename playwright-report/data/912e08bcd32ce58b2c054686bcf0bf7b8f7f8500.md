...
- Name: tests/e2e/auth.spec.ts >> @P0 @Auth Story-1.1: Authentication Journey >> [P0] should redirect to dashboard after successful login (via test session injection)
